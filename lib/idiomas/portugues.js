...
const smsAvisoAG = () => { return `╰⚠️ *ATENÇÃO* ⚠️╮\n\n` }
...
const smsRowner = () => { return `\`\`\`ESSE COMANDO SÓ EU COMO CRIADOR DO BOT POSSO USAR!!\`\`\`` }
...
const smsBotAdmin = () => { return `\`\`\`PRECISO SER ADMIN DO GRUPO PARA QUE VOCÊ POSSA USAR ESTE COMANDO!!\`\`\`` }
const smsUnreg = () => { return `\`\`\`VOCÊ PRECISA ESTAR REGISTRADO PARA USAR ESTE COMANDO, DIGITE #reg PARA REGISTRAR!!\`\`\`` }
const smsRestrict = () => { return `\`\`\`ESSE COMANDO É RESTRITO PELO MEU CRIADOR!!\`\`\`` }

//LISTA DE MENUS
const smsTime = () => { return `Hora atual`}
const smsUptime = () => { return `Online durante`}
...
const smsBanUsers = () => { return `Usuários banidos`}
...
const smsLista1 = () => { return `🌟 INFORMAÇÕES DO BOT 🌟`}
...
const smsLista7 = () => { return `INSTALAR`}
const smsLista8 = () => { return `🍄 SEJA SUB-BOT 🍄`}
const smsLista9 = () => { return `📄 TERMOS, CONDIÇÕES E PRIVACIDADE 📄`}
const smsLista10 = () => { return `🌟 AVENTURA E TOPS 🌟`}
const smsLista11 = () => { return `🏆 TOP MUNDIAL 🏆`}
...
const smsLista16 = () => { return `🏪 LOJA 🏪`}
const smsLista17 = () => { return `🎒 INVENTÁRIO 🎒`}
const smsLista18 = () => { return `🌟 MULTIMÍDIA 🌟`}
const smsLista19 = () => { return `📲 MENU DE DOWNLOAD 📲`}
const smsLista20 = () => { return `🔍 MENU DE PESQUISA 🔍`}
const smsLista21 = () => { return `🛰️ MENU CONVERSOR 🛰️`}
...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *SAIU DO GRUPO, VOLTE EM BREVE (Ou não)* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user AGORA VOCÊ É ADMINISTRADOR DO GRUPO!!*'}
const smsSdemote = () => { return '*@user NÃO É MAIS ADMINISTRADOR DO GRUPO!!*'}
...
const smsSrevoke = () => { return '*AGORA ESTE É O NOVO LINK DO GRUPO!!*\n\n*@revoke*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'GS-BOT - WhatsApp '}
const smsApagar = () => { return '❌ DESATIVAR'}
const smsEncender = () => { return '✅ ATIVAR'}
const smsEnlaceTik = () => { return `*❗️LINKS DO TIKTOK NÃO SÃO PERMITIDOS*\n\n*VOCÊ VAI SER BANIDO*`}
const smsEnlaceYt = () => { return `*❗️LINKS DO YOUTUBE NÃO SÃO PERMITIDOS*\n\n*VOCÊ VAI SER BANIDO*`}
const smsEnlaceTel = () => { return `*❗️LINKS DO TELEGRAM NÃO SÃO PERMITIDOS*\n\n*VOCÊ VAI SER BANIDO*`}
const smsEnlaceFb = () => { return `*❗️LINKS DO FACEBOOK NÃO SÃO PERMITIDOS*\n\n*VOCÊ VAI SER BANIDO*`}
const smsEnlaceIg = () => { return `*❗️LINKS DO INSTAGRAM NÃO SÃO PERMITIDOS*\n\n*VOCÊ VAI SER BANIDO*`}
const smsEnlaceTw = () => { return `*❗️LINKS DO TWITTER NÃO SÃO PERMITIDOS*\n\n*VOCÊ VAI SER BANIDO*`}
const smsAllAdmin = () => { return `*❗️PRECISO SER ADMINISTRADOR DO GRUPO PARA REMOVER INTRUSOS*`}
const smsSoloOwner = () => { return `*❗️MEU CRIADOR DEVE ATIVAR A FUNÇÃO*\n*#on restrict*`}

//handler.js
const smsCont1 = () => { return `*🔴 FALHA NO COMANDO 🔴*`}
const smsCont2 = () => { return `*⚠️ PLUGIN:*`}
const smsCont3 = () => { return `*⚠️ USUÁRIO:*`}
const smsCont4 = () => { return `*⚠️ COMANDO:*`}
const smsCont5 = () => { return `*⚠️ ERRO:*`}
const smsCont6 = () => { return `*❗ REPORTE ESTA MENSAGEM USANDO O COMANDO #reporte PARA ANALISE*`}
const smsCont7 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*NÃO EXISTE DIAMANTES!! 💎 VOCÊ PODE IR À LOJA COM O COMANDO*`}
const smsCont8 = () => { return ` *DIAMANTE 💎 USADO*`}
const smsCont9 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*PRECISA DO NÍVEL ➡️*`}
...
const smsCont13 = () => { return `ALGUÉM ENTROU!! 🥳`}
...
const smsCont18 = () => { return `*NÃO ESTÃO AUTORIZADAS, VOCÊ SERA BLOQUEADO*\n\n*SE LIGOU POR ACIDENTE, ENTRE EM CONTATO COM O CRIADOR DO BOT*`}
...
const smsInt2 = () => { return `*NÃO É PERMITIDO NO GRUPO!!*`}

//_antilink.js
const smsAdwa = () => { return `${global.lenguajeGB['smsAvisoEG']()}*NÃO POSSO BANIR ADMINISTRADORES🫂*`}
const smsEnlaceWat = () => { return `${lenguajeGB['smsAvisoAG']()}*UM LINK PROIBIDO FOI DETECTADO (LINK DE WHATSAPP)*\n\n*BAN IMEDIATO...*`}

//_antilink2.js
const smsEnlaceWatt = () => { return `${lenguajeGB['smsAvisoAG']()}*UM LINK PROIBIDO CONTENDO HTTPS FOI DETECTADO NO GRUPO*\n\n*BAN IMEDIATO...*`}
